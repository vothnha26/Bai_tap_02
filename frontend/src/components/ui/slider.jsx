    ...
    >
      ...
      {Array.from({ length: _values.length }, (_, index) => (
        <SliderPrimitive.Thumb
          ...
          key={index}
          className="bg-white border-2 border-blue-600 block size-5 shrink-0 rounded-full shadow-md transition-transform hover:scale-110 focus:outline-none disabled:pointer-events-none disabled:opacity-50 cursor-grab active:cursor-grabbing"
        />
      ))}
    </SliderPrimitive.Root>
  );
